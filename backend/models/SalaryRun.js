...
const payslipEntrySchema = new Schema(
  {
    ...
    allowance_ns_entitled: { type: Number, default: 0 },
    ...
    no_pay_from_hours: { type: Number, default: 0 },
    standard_hours: { type: Number, default: 0 },
    actual_hours: { type: Number, default: 0 },
    shortfall_hours: { type: Number, default: 0 },
    intern_no_pay_waived: { type: Boolean, default: false },
    no_pay_calculated: { type: Number, default: 0 },
