...
router.get("/:id/assignees", authMiddleware, authorizeRoles("admin", "hr"), getLeaveAssignees);
router.put("/:id/assign", authMiddleware, authorizeRoles("admin", "hr"), assignLeave);
